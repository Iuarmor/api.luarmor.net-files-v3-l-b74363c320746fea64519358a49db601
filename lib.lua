...
function library.new(library_title, cfg_location)
    ...
    function menu.new_tab(tab_image)
        ...
        if is_first_tab then
            ...
            TabImage.ImageColor3 = Color3.fromRGB(20, 210, 20)
            Tab.Visible = true
        end
        ...
        TabButton.MouseButton1Down:Connect(function()
            ...
            Tab.Visible = true
            selected_tab = TabButton
            library:tween(TabImage, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {ImageColor3 = Color3.fromRGB(20, 210, 20)})
        end)
        ...
        function tab.new_section(section_name)
            ...
            SectionButton.MouseButton1Down:Connect(function()
                ...
                library:tween(SectionButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(20, 210, 20)})
            ...
            if is_first_section then
                ...
                SectionButton.TextColor3 = Color3.fromRGB(20, 210, 20) 
            ...
            function section.new_sector(sector_name, sector_side)
                ...
                function sector.element(type, text, data, callback, c_flag)
                    ...
                    if type == "Toggle" then
                        ...
                        function element:set_value(new_value, cb)
                            ...
                            if value.Toggle then
                                library:tween(ToggleFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BackgroundColor3 = Color3.fromRGB(20, 210, 20)})
                        ...
                        function element:add_keybind(key_default, key_callback)
                            ...
                            KeybindFrame.MouseEnter:Connect(function()
                                keybind_in2 = true
                                library:tween(KeybindFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(20, 210, 20)})
                            end)
                            ...
                            local Always = library:create("TextButton", {
                                ...
                                Font = Enum.Font.Ubuntu,
                                Text = "Always",
                                TextColor3 = Color3.fromRGB(20, 210, 20),
                                TextSize = 14,
                                ZIndex = 2,
                            }, KeybindFrame)
                            ...
                            for _,TypeButton in next, KeybindFrame:GetChildren() do
                                ...
                                TypeButton.MouseButton1Down:Connect(function()
                                    ...
                                    library:tween(TypeButton, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(20, 210, 20)})
                                end)
                            end
                            ...
                            function keybind:set_value(new_value, cb)
                                ...
                                for _,TypeButton2 in next, KeybindFrame:GetChildren() do
                                    ...
                                    if TypeButton2.Name ~= extra_value.Type then
                                        ...
                                        library:tween(TypeButton2, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {TextColor3 = Color3.fromRGB(20, 210, 20)})
                                    end
                                end
                        ...
                        function element:add_color(color_default, has_transparency, color_callback)
                            ...
                            ColorFrame.MouseEnter:Connect(function()
                                in_color = true
                                library:tween(ColorFrame, TweenInfo.new(0.2, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(20, 210, 20)})
                            end)
                    ...
                    elseif type == "Dropdown" then
                        ...
                        for _,v in next, data.options do
                            ...
                            local Decoration = library:create("Frame", {
                                Name = "Decoration",
                                BackgroundColor3 = Color3.fromRGB(20, 210, 20),
                                BorderSizePixel = 0,
                                Size = UDim2.new(0, 1, 1, 0),
                                Visible = false,
                                ZIndex = 2,
                    ...
                    elseif type == "Button" then
                        ...
                        Button.MouseButton1Down:Connect(function()
                            Button.BorderColor3 = Color3.fromRGB(20, 210, 20)
                    ...
                    elseif type == "TextBox" then
                        ...
                        uis.TextBoxFocused:connect(function()
                            if uis:GetFocusedTextBox() == TextBox then
                                library:tween(TextBox, TweenInfo.new(0.3, Enum.EasingStyle.Quad, Enum.EasingDirection.Out), {BorderColor3 = Color3.fromRGB(20, 210, 20)})
                            end
                        end)
                    ...
                    elseif type == "Scroll" then
                        ...
                        local ScrollFrame = library:create("ScrollingFrame", {
                            ...
                            TopImage = "rbxasset://textures/ui/Scroll/scroll-middle.png",
                            AnchorPoint = Vector2.new(0.5, 0),
                            ScrollBarImageColor3 = Color3.fromRGB(20, 210, 20),
                        }, Scroll)
